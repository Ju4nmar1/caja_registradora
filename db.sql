...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2024 a las 07:09:09
...
CREATE TABLE `cliente` (
  ...
  `tipo_cliente` enum('Natural','Jurídico') NOT NULL
...
INSERT INTO `cliente` (`id_cliente`, `nombre`, `cedula_nit`, `tipo_cliente`) VALUES
(1, 'Juan Hernandez', '123456789', 'Natural');
...
INSERT INTO `productos` (`id_producto`, `nombre_producto`, `codigo_producto`, `precio_producto`, `cantidad_stock`) VALUES
(1, 'Producto 1', 'PRD001', 100.00, 90),
(2, 'Producto 2', 'PRD002', 150.00, 90);
...
INSERT INTO `ventas` (`id_venta`, `id_cliente`, `fecha_venta`, `total_sin_iva`, `total_iva`, `total_con_iva`) VALUES
(1, 1, '2024-12-01 23:58:47', 2500.00, 475.00, 2975.00);
